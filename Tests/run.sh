...
xcrun swiftc -swift-version 5 Mocpot/Sources/PlayerViewModel.swift Mocpot/Sources/MediaSettings.swift Mocpot/Sources/FormatCompatibility.swift Mocpot/Sources/PictureInPictureController.swift Tests/PlaybackRegression.swift -o "$fixture_dir/PlaybackRegression"
